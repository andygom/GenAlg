...
class POPULATION: 
      ...
      def Winner_Of_Tournament_Selection(self, other, i):
        ...
        a0 = other.p[newp0].genomeh[0:7,:]
        a1 = other.p[newp0].genomeh[7:14,:]
        b0 = other.p[newp1].genomeh[0:7,:]
        b1 = other.p[newp1].genomeh[7:14,:]
        newgenomeh1 =  np.concatenate((a0, b1), axis = 0)
        newgenomeh2 =  np.concatenate((b0, a1), axis = 0)

        genomewinner1.genomeh = newgenomeh1
        genomewinner2.genomeh = newgenomeh2

        a0 = other.p[newp0].genomeop[0:7,:]
        a1 = other.p[newp0].genomeop[7:14,:]
        b0 = other.p[newp1].genomeop[0:7,:]
        b1 = other.p[newp1].genomeop[7:14,:]
        newgenomeop1 =  np.concatenate((a0, b1), axis = 0)
        newgenomeop2 =  np.concatenate((b0, a1), axis = 0)
